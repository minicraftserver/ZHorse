...
public enum KeyWordEnum {
	...
	CROSSABLE_SUFFIX(".crossable"),
       DATABASE("Databases.mariadb-config.database"),
	DATABASES("Databases"),
	...
	HORSENAMES("HorseNames"),
       HOST("Databases.mariadb-config.host"),
	LANGUAGES("Languages"),
	...
	MUTE_CONSOLE("Settings.mute-console"),
       PASSWORD("Databases.mariadb-config.password"),
	PERMISSION_SUFFIX(".permission"),
       PORT("Databases.mariadb-config.port"),
